...
urlpatterns = patterns('',
    ...
    url(r'^directors/(?P<pk>\d+)/delete/$',
	 ...
	 # RESTful API
    url(r'^api/pelicules/$', APIPeliculesList.as_view(), name='pelicula-list'),
    url(r'^api/pelicules/(?P<pk>\d+)/$', APIPeliculesDetail.as_view(), name='pelicula-detail'),
    url(r'^api/generes/$', APIGeneresList.as_view(), name='genere-list'),
    url(r'^api/generes/(?P<pk>\d+)/$', APIGeneresList.as_view(), name='genere-detail'),
    url(r'^api/actors/$', APIActorsList.as_view(), name='actor-list'),
    url(r'^api/actors/(?P<pk>\d+)/$', APIActorsDetail.as_view(), name='actor-detail'),
	 url(r'^api/directors/$', APIDirectorsList.as_view(), name='director-list'),
    url(r'^api/directors/(?P<pk>\d+)/$', APIDirectorsDetail.as_view(), name='director-detail'),
)
